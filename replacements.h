...
Modifies the intensity of the light emitted by the sky.|修改天空发出的光的强度。
Apparent sky brightness modifier|天空表观亮度调节
Modifies the apparent brightness of the sky.|修改天空的表观亮度。
Allow blocks to emit light based on their material settings.|允许基于材质设置的方块发光。
Emitter intensity|发射器强度
Modifies the intensity of emitter light.|修改发射器光的强度。
Reload chunks|重载区块
...
Importance sample chance|重要性采样机会
...
Apparent sun brightness|太阳表观亮度
